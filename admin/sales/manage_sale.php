...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Información de Ventas - " . $sales_code : 'Nueva Venta' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="sale-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="client" class="control-label text-info">Nombre del Cliente</label>
                            <input type="text" name="client" class="form-control form-control-sm rounded-0" value="<?php echo isset($client) ? $client : 'cliente genérico' ?>">
                        </div>
                    </div>
                </div>
                <hr>
                <fieldset>
                    <legend class="text-info">Información de Producto</legend>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="remarks" class="text-info control-label"></label>
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-warning" type="submit" form="sale-form">Guardar</button>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=sale' ?>">Cancelar</a>
    </div>
</div>
...
<script>
    ...
    $(function() {
        ...
        $('#add_to_list').click(function() {
            ...
            if (item == '' || qty == '' || unit == '') {
                alert_toast('Diligencia de producto son requeridos', 'warning');
                return false;
            }
            if ($('table#list tbody').find('tr[data-id="' + item + '"]').length > 0) {
                alert_toast('Producto ya ingresado en la lista', 'error');
                return false;
            }
