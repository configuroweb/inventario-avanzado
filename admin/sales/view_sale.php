...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Registro de Ventas - <?php echo $sales_code ?></h4>
    </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-warning" href="<?php echo base_url . '/admin?page=sales/manage_sale&id=' . (isset($id) ? $id : '') ?>">Editar</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=sales' ?>">Volver</a>
    </div>
</div>
...
<script>
    $(function() {
        $('#print').click(function() {
            ...
            _head.find('title').text("Registro de Ventas - Vista de Impresión")
