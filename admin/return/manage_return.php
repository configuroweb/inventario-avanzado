...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Información Devolución - " . $return_code : 'Nueva Devolución' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="return-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label text-info">Código Devolución</label>
                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-2 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-flat btn-sm btn-primary" id="add_to_list">Agregar Producto</button>
                            </div>
                        </div>
                </fieldset>
                <hr>
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-warning" type="submit" form="return-form">Guardar</button>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=return' ?>">Cancelar</a>
    </div>
</div>
    ...
    $(function() {
        ...
        $('#supplier_id').change(function() {
            ...
            if (!!items[supplier_id]) {
                ...
                list_item.then(function() {
                    $('#item_id').select2({
                        placeholder: "Sin productos listados",
                        width: 'resolve',
                    })
                })
            }
        ...
        $('#add_to_list').click(function() {
            ...
            if (item == '' || qty == '' || unit == '') {
                alert_toast('Productos son requeridos.', 'warning');
                return false;
            }
