...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Registro Devolución - <?php echo $return_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            ...
            <h4 class="text-info">Producto</h4>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-warning" href="<?php echo base_url . '/admin?page=return/manage_return&id=' . (isset($id) ? $id : '') ?>">Editar</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=return' ?>">Volver</a>
    </div>
</div>
...
<script>
    $(function() {
        $('#print').click(function() {
            ...
            _head.find('title').text("Devolver Registro - Vista Impresión")
            ...
            _el.append('<div class="d-flex justify-content-center">' +
                ...
                '<h4 class="text-center">Devolver Registro</h4>' +
                '</div>' +
                '<div class="col-1 text-right">' +
                '</div>' +
                '</div><hr/>')
