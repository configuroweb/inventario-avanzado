...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Información Orden de Compra - <?php echo $po_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <?php if ($status > 0) : ?>
                    <div class="col-md-6">
                        <span class="text-info"><?php echo ($status == 2) ? "Recibido" : "Recibido Parcialmente" ?></span>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-warning" href="<?php echo base_url . '/admin?page=purchase_order/manage_po&id=' . (isset($id) ? $id : '') ?>">Editar</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=purchase_order' ?>">Volver</a>
    </div>
</div>
