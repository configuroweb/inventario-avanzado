...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Información Orden de Compra - " . $po_code : 'Crear Nueva Orden de Compra' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="po-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label text-info">Código de Compra</label>
                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="qty" class="control-label">Cantidad</label>
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">Descuento <input style="width:40px !important" name="discount_perc" class='' type="number" min="0" max="100" value="<?php echo isset($discount_perc) ? $discount_perc : 0 ?>">%
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">Impuesto <input style="width:40px !important" name="tax_perc" class='' type="number" min="0" max="100" value="<?php echo isset($tax_perc) ? $tax_perc : 0 ?>">%
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-warning" type="submit" form="po-form">Guardar</button>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=purchase_order' ?>">Cancelar</a>
    </div>
</div>
...
<script>
    ...
    $(function() {
        ...
        $('#item_id').select2({
            placeholder: "Selecciona el proveedor primero",
            width: 'resolve',
        })
        ...
        $('#supplier_id').change(function() {
            ...
            if (!!items[supplier_id]) {
                ...
                list_item.then(function() {
                    $('#item_id').select2({
                        placeholder: "Selecciona producto aquí",
                        width: 'resolve',
                    })
                })
            } else {
                list_item.then(function() {
                    $('#item_id').select2({
                        placeholder: "Sin productos disponibles",
                        width: 'resolve',
                    })
                })
            }
        ...
        $('#add_to_list').click(function() {
            ...
            if (item == '' || qty == '' || unit == '') {
                alert_toast('Los campos de texto del elemento de formulario son obligatorios.', 'warning');
                return false;
            }
            if ($('table#list tbody').find('tr[data-id="' + item + '"]').length > 0) {
                alert_toast('Productos ya existe en el listado', 'error');
                return false;
            }
