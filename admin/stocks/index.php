...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("¿Deseas eliminar esta orden recibida de forma permanente??", "delete_receiving", [$(this).attr('data-id')])
		})
		$('.view_details').click(function() {
			uni_modal("Recibir detalles", "receiving/view_receiving.php?id=" + $(this).attr('data-id'), 'mid-large')
		})
