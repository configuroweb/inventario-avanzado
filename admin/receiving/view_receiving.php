...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Orden Recibida - <?php echo $po_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">Del Código</label>
            ...
            <div class="row">
                ...
                <?php if ($status > 0) : ?>
                    <div class="col-md-6">
                        <span class="text-info"><?php echo ($status == 2) ? "Recibido" : "Parcialmente Recibido" ?></span>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-warning" href="<?php echo base_url . '/admin?page=receiving/manage_receiving&id=' . (isset($id) ? $id : '') ?>">Editar</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=receiving' ?>">Volver</a>
    </div>
</div>
...
<script>
    $(function() {
        $('#print').click(function() {
            ...
            _head.find('title').text("Órdenes Recibidad - Vista de Impresión")
            ...
            _el.append('<div class="d-flex justify-content-center">' +
                ...
                '<h4 class="text-center">Órdenes Recibidas</h4>' +
                '</div>' +
                '<div class="col-1 text-right">' +
                '</div>' +
                '</div><hr/>')
