...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo !isset($id) ? "Orden Recibida de " . $po_code : 'Actualizar Información  de Orden' ?></h4>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-warning" type="submit" form="receive-form">Guardar</button>
